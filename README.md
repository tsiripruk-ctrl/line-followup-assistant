# LINE Follow-up Assistant v0.6.5
...
## New in v0.6.5 — People Registry Profile
...
v0.6.5 performs a non-destructive additive migration on startup. Existing `people` tables receive only these missing columns:
